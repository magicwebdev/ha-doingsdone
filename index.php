        ...
        <main class="content__main">
          ...
          <table class="tasks">
            <?php foreach ($tasks as $task) : ?>
              <?php if ($task['complete'] && !$show_complete_tasks) continue; ?>
              <tr class="tasks__item task <?php if ($task['complete']) : ?>task--completed<?php endif; ?>">
                <td class="task__select">
                  <label class="checkbox task__checkbox">
                    <input class="checkbox__input visually-hidden task__checkbox" <?php if ($task['complete']) : ?>checked<?php endif; ?> type="checkbox" value="1">
